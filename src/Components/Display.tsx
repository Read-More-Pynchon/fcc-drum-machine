...
export default function Display() {
    ...
    return (
        <div id="display" className="bg-teal w-1/2 h-fit">
            <h2 className="text-2xl font-sans text-blue">Display</h2>
            
            <label>Power</label>
            <input name="power" type="checkbox" onChange={handlePowerSwitch}></input>
            ...
            <div className="m-6 p-6 bg-white text-black font-bold">
